...
public class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, int w, int h) {
        ...
        this.maskColor = resources.getColor(
          getResources().getIdentifier("viewfinder_mask", "color", context.getPackageName()));
        this.resultColor = resources.getColor(
          getResources().getIdentifier("result_view", "color", context.getPackageName()));
        this.frameColor = resources.getColor(
          getResources().getIdentifier("viewfinder_frame", "color", context.getPackageName()));
        this.laserColor = resources.getColor(
          getResources().getIdentifier("viewfinder_laser", "color", context.getPackageName()));
        this.scannerAlpha = 0;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, (float) this.frame.top, (float) this.frame.left,
          (float) (this.frame.bottom + 1), this.paint);
        canvas.drawRect((float) (this.frame.right + 1), (float) this.frame.top, (float) width,
          (float) (this.frame.bottom + 1), this.paint);
        canvas.drawRect(0.0f, (float) (this.frame.bottom + 1), (float) width, (float) height,
          this.paint);
        if (width <= height || this.boo) {
            ...
            this.paintLine.setAntiAlias(true);
            int num = t - 40;
            canvas.drawLine((float) (l - 4), (float) t, (float) (l + num), (float) t,
              this.paintLine);
            ...
            canvas.drawLine((float) r, (float) (t - 4), (float) r, (float) (t + num),
              this.paintLine);
            canvas.drawLine((float) (l - 4), (float) b, (float) (l + num), (float) b,
              this.paintLine);
            ...
            canvas.drawLine((float) r, (float) (b + 4), (float) r, (float) (b - num),
              this.paintLine);
            if (this.leftLine == 1) {
