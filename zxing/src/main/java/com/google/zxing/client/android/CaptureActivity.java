...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public static final String RESULT_DATA = "qrcode_result_data";
    ...
    protected void onResume() {
        super.onResume();
        if (checkPermission(Manifest.permission.CAMERA, android.os.Process.myPid(),
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (resultCode == RESULT_OK
          && requestCode == HISTORY_REQUEST_CODE
          && historyManager != null) {
    ...
    private void decodeOrStoreSavedBitmap(Bitmap bitmap, Result result) {
        ...
        if (handler == null) {
            ...
            if (savedResultToShow != null) {
                Message message = Message.obtain(handler, CaptureActivityHandler.DECODE_SUCCEEDED,
                  savedResultToShow);
    ...
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler,
      Bitmap barcode) {
        ...
        intent.putExtra(RESULT_DATA, rawResult.getText());
      ...
      Bitmap barcode) {
        ...
        switch (source) {
            case NATIVE_APP_INTENT:
                ...
                sendReplyMessage(CaptureActivityHandler.RETURN_SCAN_RESULT, intent,
                  resultDurationMS);
                break;
            ...
            case PRODUCT_SEARCH_LINK:
                ...
                sendReplyMessage(CaptureActivityHandler.LAUNCH_PRODUCT_QUERY, productReplyURL,
                  resultDurationMS);
                break;
            ...
            case ZXING_LINK:
                if (scanFromWebPageManager != null && scanFromWebPageManager.isScanFromWebPage()) {
                    String linkReplyURL =
                      scanFromWebPageManager.buildReplyURL(rawResult, resultHandler);
                    scanFromWebPageManager = null;
                    sendReplyMessage(CaptureActivityHandler.LAUNCH_PRODUCT_QUERY, linkReplyURL,
                      resultDurationMS);
                }
                break;
        }
      ...
      int[] grantResults) {
        ...
        if (requestCode == REQUEST_CAMERA) {
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(this, "暂无相机权限，无法扫描二维码，请跳转设置给予。", Toast.LENGTH_LONG).show();
            }
        }
    }
}
